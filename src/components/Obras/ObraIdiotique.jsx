    ...
    <div className='obraIdiotiqueContainer1'>
      ...
      <Row className='obraIdiotiqueRow3'>
        <Col className='obraIdiotiqueColumn1' xs={12} lg={6}>
          <div>
            <video src="/assets/videos/obras/idiotique/reelIdioteque.mp4" controls></video>
          </div>
        </Col>
      </Row>
      <Row className='obraIdiotiqueRow4'>
          ...
          <Col className='obraIdiotiqueColumn2' xs={12} lg={6}>
            <div className='boxImg1'>
              <div>
                <img className='img1' src="/assets/images/obras/idiotique/Recurso 16.png" alt="" />
              </div>
              <div>
                <img className='img2' src="/assets/images/obras/idiotique/Recurso 15.png" alt="" />
                <img className='img3' src="/assets/images/obras/idiotique/Recurso 14.png" alt="" />
              </div>
              <div>
                <img className='img4' src="/assets/images/obras/idiotique/Recurso 13.png" alt="" />
              </div>
            </div>
          </Col>
        </Row>
